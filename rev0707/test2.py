...
Original file is located at
    https://colab.research.google.com/drive/1yequEEAQjt3x8AEbbRG3BquizlzFTf5l
...
dir_path = "/content/drive/MyDrive/age_test/UTKFace/"
...
# Split image paths into 80% train, 10% validation, 10% test (no overlap)
n_total = len(image_paths)
n_train = int(0.8 * n_total)
n_val = int(0.1 * n_total)

train_images = image_paths[:n_train]
valid_images = image_paths[n_train:n_train + n_val]
...
age_history = age_net.fit(
    ...
    callbacks = [
        ...
        ModelCheckpoint(
            "/content/drive/MyDrive/age_test/Age-VGG16.keras",
            save_best_only=True
        )
    ]
)
...
gender_history = gender_net.fit(
    ...
    callbacks = [
        ...
        ModelCheckpoint(
            "/content/drive/MyDrive/age_test/Gender-ResNet152.keras",
            save_best_only=True
        )
    ]
)
...
age_net = tf.keras.models.load_model("/content/drive/MyDrive/age_test/Age-VGG16.keras", compile=True)
gender_net = tf.keras.models.load_model("/content/drive/MyDrive/age_test/Gender-ResNet152.keras", compile=True)
...
# 모델 경로
AGE_MODEL_PATH = "/content/drive/MyDrive/age_test/Age-VGG16.keras"
GENDER_MODEL_PATH = "/content/drive/MyDrive/age_test/Gender-ResNet152.keras"
